...
train_cfg_1, train_cfg_2,train_fea_1, train_fea_2, train_num1, train_num2, train_max \
...
for item1,item2,item3,item4,item5,item6, item7, item8 in itertools.izip(
        train_label, train_cfg_1, train_cfg_2, train_fea_1, train_fea_2,
...
valid_cfg_1, valid_cfg_2, valid_fea_1, valid_fea_2, valid_num1, valid_num2, valid_max \
...
for item1,item2,item3,item4,item5,item6, item7, item8 in itertools.izip(
        valid_label, valid_cfg_1, valid_cfg_2, valid_fea_1, valid_fea_2,
...
# ======================= construct test data =====================
test_cfg_1, test_cfg_2, test_fea_1, test_fea_2,test_num1, test_num2, test_max \
...
for item1,item2,item3,item4,item5,item6, item7, item8 in itertools.izip(
        test_label, test_cfg_1, test_cfg_2, test_fea_1, test_fea_2,
